...
if !exists('g:AutoPairsShortcutFastUnwrap')
    let g:AutoPairsShortcutFastUnwrap = '<M-r>'
end
...
func! AutoPairsFastWrap()
    ...
    if g:AutoPairsMultilineClose && col('.') < col_before
        let after = after[2:]
    endif
...
func! AutoPairsInit()
    ...
    if g:AutoPairsShortcutFastUnwrap != ''
        execute 'inoremap <buffer> <silent> '.g:AutoPairsShortcutFastUnwrap.' <C-R>=AutoPairsFastUnwrap()<CR>'
    end
